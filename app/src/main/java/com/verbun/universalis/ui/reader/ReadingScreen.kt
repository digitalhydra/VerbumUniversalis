...
import com.verbun.universalis.ui.components.BookPickerScreen
...
fun ReadingScreen(
    ...
    VerbumTheme {
                    ...
                    when (action) {
                        "interlinear" -> {
                            navController.navigate(
                                com.verbun.universalis.ui.navigation.Route.InterlinearReader.createRoute(verseId)
                            )
                        }
        ...
        if (showNoteBottomSheet) {
            com.verbun.universalis.ui.components.NoteBottomSheet(
        ...
        if (showHighlightPicker) {
            com.verbun.universalis.ui.components.ColorPickerBottomSheet(
